...
function stopObserving() {
  if (startObserving._interval) {
    clearInterval(startObserving._interval);
    startObserving._interval = null;
  }
  if (observer) {
    observer.disconnect();
    observer = null;
